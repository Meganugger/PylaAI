        ...
        for phase in ("current_position", "from_top"):
            ...
            for i in range(70):
                ...
                if match:
                    ...
                    # Phase 5: clamp click to stay within the detected text region
                    text_top = int(text_box.get("top", y) / ocr_scale) if "top" in text_box else click_y
                    click_y = max(text_top, click_y)
